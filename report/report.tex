\documentclass[journal,transmag]{IEEEtran}
    ...
    \author{
        \IEEEauthorblockN{Onur Temizkan}
        \IEEEauthorblockA{
    ...
    \begin{abstract}
        \textit{
            Abstract: Traveling Salesman Problem (TSP) is a common NP-Complete problem in
            Computer Science and Optimization. Thus, there is no known way to solve it
            in polynomial time at the time of this writing.
            In this report, we will analyse Genetic algorithm approach to TSP and compare it with
            Brute-Force Search method.
        }
    \end{abstract}

    \begin{IEEEkeywords}
    traveling salesman problem, optimization, genetic algorithm, TSP, combinatorics.
    \end{IEEEkeywords}}
    ...
    \IEEEPARstart{I}{n} this report, we strived to analyze the performance of a genetic algorithm,
